...
<div style="width:1000px;margin:auto;">
	<form action="/addCar" method="post" style="float:left;width:33%;">
		<fieldset>
	...
	<form action="/changeCar" method="post" style="float:left;width:33%;">
		<fieldset>
	...
	<form action="/deleteCar" method="post" style="float:left;width:33%;">
		<fieldset>
